...
<body id="contact" class="pre-account contact has-footer">
  ...
  <section class="container">
    <div class="box">
      ...
      ?>
      <?php if (!empty($pngm_contact['phone']) || !empty($pngm_contact['email'])) { ?>
        <div class="pngm-contact-details">
          <?php if (!empty($pngm_contact['phone'])) { ?>
            <p><?php _e('Phone', 'epsilon'); ?>: <a href="tel:<?php echo osc_esc_html($pngm_contact['tel']); ?>"><?php echo osc_esc_html($pngm_contact['phone']); ?></a></p>
          <?php } ?>
          <?php if (!empty($pngm_contact['email'])) { ?>
            <p><?php _e('Email', 'epsilon'); ?>: <a href="mailto:<?php echo osc_esc_html($pngm_contact['email']); ?>"><?php echo osc_esc_html($pngm_contact['email']); ?></a></p>
          <?php } ?>
        </div>
      <?php } ?>
