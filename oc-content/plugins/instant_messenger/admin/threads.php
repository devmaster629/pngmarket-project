      ...
      <div class="mb-table im_list">
        ...
        <?php foreach($threads as $t) { ?>
          ...
          <div class="mb-table-row">
            ...
            <div class="mb-col-5 mb-align-left"><?php
              if(isset($item['pk_i_id'])) {
                echo '<a href="' . osc_admin_base_url(true) . '?page=items&action=item_edit&id=' . $item['pk_i_id'] . '" target="_blank">' . osc_highlight($item['s_title'], 25) . ' (#' . $item['pk_i_id'] . ')</a>';
              } else if((int)$t['fk_i_item_id'] > 0) {
                echo __('Listing removed', 'instant_messenger') . ' (#' . (int)$t['fk_i_item_id'] . ')';
              } else {
